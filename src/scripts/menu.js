...
import cocktailImage from "../images/cocktail.jpeg";
...
function menuLoad() {
  ...
  const cocktailDescription = document.createElement("div");
  const cocktailTitle = document.createElement("h1");
  const cocktailTitleText = document.createTextNode("Mystery Cocktail");
  const cocktailDescriptionText = document.createTextNode(
    "Discover a mysterious blend of bold spirits, sweet liqueurs, and a hint of bitters. Served in a chilled glass, every sip will leave you guessing and eager for another taste. Come and indulge in the mystery, and let the unexpected flavors unfold before you. A different cocktail experience awaits you every night."
  );
  ...
  cocktail.setAttribute("class", "cocktail");
  cocktail.setAttribute("src", cocktailImage);
  cocktailDescription.setAttribute("class", "cocktail-description");
  ...
  menuContainer.appendChild(cocktail);
  menuContainer.appendChild(cocktailDescription);
  cocktailDescription.appendChild(cocktailTitle);
  cocktailTitle.appendChild(cocktailTitleText);
  cocktailDescription.appendChild(cocktailDescriptionText);
